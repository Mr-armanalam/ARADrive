...
?>
<h1 class="text-center mt-3 mb-4">Favourite Files</h1>
<div class="row">
    ...
    <?php 
        ...
        while($file_array = $file_res->fetch_assoc()){
            $fd_array = pathinfo(($file_array['file_name'])); //for extension
                ...
                <div class="col-md-4">
                    <div class="d-flex border align-items-center p-3 mb-3">
                        ...
                        <hr>
                            ...
                            <a href="data/'.$tf.'/'.$basename.'" target="blank"><i class="fa-regular fa-eye"></i></a>
                            <a href="data/'.$tf.'/'.$basename.'" download><i class="fa-solid fa-download"></i></a>
                            <a><i class="fa-solid fa-trash del" id="'.$file_array['id'].'" folder="'.$tf.'" file="'.$basename.'"></i></a>';
                            
                            if($file_array['star']== "yes"){
                                echo '<i class="fas fa-star text-warning star" folder="'.$tf.'" status="no" id="'.$file_array['id'].'"></i>';
                            }
                            else{
                                echo '<i class="fas fa-star text-secondary star" folder="'.$tf.'" status="yes" id="'.$file_array['id'].'"></i>';
                            }
